(() => {
    ...
    async function loadStores() {
        try {
            ...
            const heading = document.createElement('h2'); heading.textContent = 'Ana Depo · Dağıtım Deposu'; section.append(heading);
            const products = await window.NebimAdapter.getProducts();
